...
export const TRANSACTION_PAYMENT_METHODS = [
  ...
  { id: "papss", name: "PAPSS Payment" },
  { id: "airtime", name: "Airtime" },
  { id: "wallet-to-bank", name: "Wallet to Bank" },
  { id: "data", name: "Data" },
  { id: "gip", name: "GhIPSS Instant (GIP)" },
  { id: "ach", name: "ACH Direct Credit" },
  { id: "rtgs", name: "RTGS High Value" },
  { id: "momo", name: "Mobile Money (MoMo)" },
  { id: "own-account", name: "Between My Accounts" },
  { id: "card", name: "Card / POS Payment" },
  { id: "bill", name: "Bill Payment" },
...
export const TRANSACTIONS: Transaction[] = [
  ...
  {
    id: "txn-010",
    reference: "NIB-2026-883204",
    date: "2026-08-10",
    valueDate: "2026-08-10",
    description: "Corporate Fleet Fuel & Transit — Shell Airport",
    counterparty: "Shell Ghana Ltd",
    counterpartyAccount: "0123 9988 7744",
    accountId: "acc-001",
    currency: "GHS",
    amount: 2_400.0,
    direction: "debit",
  ...
  {
    id: "txn-011",
    reference: "NIB-2026-883199",
    date: "2026-08-09",
    valueDate: "2026-08-09",
    description: "Wallet to Bank pull — MTN MoMo Merchant",
    counterparty: "MTN Mobile Money Merchant",
    counterpartyAccount: "0244 8899 00",
    accountId: "acc-001",
    currency: "GHS",
    amount: 14_500.0,
    direction: "credit",
    ...
    state: "completed",
    channel: "Mobile Banking",
    paymentMethod: "wallet-to-bank",
    profileKind: "CORPORATE",
  },
  {
    id: "txn-012",
    reference: "NIB-2026-883042",
    date: "2026-08-08",
    valueDate: "2026-08-08",
    description: "PAPSS cross-border settlement — Ecobank Lagos",
    counterparty: "Lagos Commodities Trading",
    counterpartyAccount: "NG-ECO-992100",
    accountId: "acc-001",
    currency: "GHS",
    amount: 36_800.0,
    direction: "debit",
  ...
  {
    id: "txn-013",
    reference: "NIB-2026-882980",
    date: "2026-08-07",
    valueDate: "2026-08-07",
    description: "GhIPSS Instant Pay (GIP) — Fidelity Bank",
    counterparty: "Kaneshie Paper Mill",
    counterpartyAccount: "0551 2233 4455",
    accountId: "acc-001",
    currency: "GHS",
    amount: 8_200.0,
    direction: "debit",
  ...
  {
    id: "txn-014",
    reference: "NIB-2026-882850",
    date: "2026-08-05",
    valueDate: "2026-08-05",
    description: "Internal Transfer Between My Accounts",
    counterparty: "GCB Operating to GCB Reserve",
    counterpartyAccount: "acc-002",
    accountId: "acc-001",
    currency: "GHS",
    amount: 50_000.0,
    direction: "debit",
  ...
  {
    id: "txn-015",
    reference: "NIB-2026-882710",
    date: "2026-08-03",
    valueDate: "2026-08-03",
    description: "Turbonet Office Data Bundle — MTN 200GB",
    counterparty: "MTN Ghana",
    counterpartyAccount: "0244 0000 01",
    accountId: "acc-001",
    currency: "GHS",
    amount: 650.0,
    direction: "debit",
  ...
  {
    id: "txn-ret-009",
    reference: "NIB-2026-901132",
    date: "2026-08-08",
    valueDate: "2026-08-08",
    description: "PAPSS Remittance — Family Support Kenya",
    counterparty: "K. Mensah (KCB Nairobi)",
    counterpartyAccount: "KE-KCB-449100",
    accountId: "acc-ret-002",
    currency: "GHS",
    amount: 3_500.0,
    direction: "debit",
  ...
  {
    id: "txn-ret-013",
    reference: "NIB-2026-901136",
    date: "2026-08-03",
    valueDate: "2026-08-03",
    description: "ECG Prepaid Electricity Top-up",
    counterparty: "Electricity Company of Ghana",
    counterpartyAccount: "0300 4455 6677",
    accountId: "acc-ret-002",
    currency: "GHS",
    amount: 250.0,
    direction: "debit",
  ...
  {
    id: "txn-ret-014",
    reference: "NIB-2026-901137",
    date: "2026-08-02",
    valueDate: "2026-08-02",
    description: "Ghana Water Company Bill",
    counterparty: "Ghana Water Ltd",
    counterpartyAccount: "0300 5566 7788",
    accountId: "acc-ret-002",
    currency: "GHS",
    amount: 85.0,
    direction: "debit",
  ...
  {
    id: "txn-ret-015",
    reference: "NIB-2026-901138",
    date: "2026-08-01",
    valueDate: "2026-08-01",
    description: "Salary Advance Settlement",
  ...
  {
    id: "txn-ret-016",
    reference: "NIB-2026-901139",
    date: "2026-07-30",
    valueDate: "2026-07-30",
    description: "Fuel Station Purchase — TotalEnergies",
    counterparty: "TotalEnergies Ghana",
    counterpartyAccount: "0200 9900 1122",
    accountId: "acc-ret-002",
    currency: "GHS",
    amount: 400.0,
    direction: "debit",
  ...
  {
    id: "txn-ret-017",
    reference: "NIB-2026-901140",
    date: "2026-07-28",
    valueDate: "2026-07-28",
    description: "Pharmacy Settlement — Danpong",
    counterparty: "Danpong Healthcare",
    counterpartyAccount: "0100 3344 5566",
    accountId: "acc-ret-002",
    currency: "GHS",
    amount: 180.0,
    direction: "debit",
  ...
  {
    id: "txn-ret-019",
    reference: "NIB-2026-901142",
    date: "2026-07-22",
    valueDate: "2026-07-22",
    description: "Airtime Top-up — MTN 50 GHS",
    counterparty: "MTN Ghana",
    counterpartyAccount: "0244 0000 01",
    accountId: "acc-ret-002",
    currency: "GHS",
  ...
  {
    id: "txn-ret-020",
    reference: "NIB-2026-901143",
    date: "2026-07-20",
    valueDate: "2026-07-20",
    description: "Bolt Ride — Osu to Cantonments",
    counterparty: "Bolt Operations OU",
    counterpartyAccount: "EE-BOLT-9901",
    accountId: "acc-ret-002",
    currency: "GHS",
    amount: 42.0,
    direction: "debit",
  ...
  {
    id: "txn-ret-021",
    reference: "NIB-2026-901144",
    date: "2026-07-18",
    valueDate: "2026-07-18",
    description: "ATM Cash Withdrawal — High Street",
    counterparty: "GCB ATM Branch",
    counterpartyAccount: "GCB-ATM-044",
    accountId: "acc-ret-002",
    currency: "GHS",
    amount: 600.0,
    direction: "debit",
  ...
  {
    id: "txn-ret-022",
    reference: "NIB-2026-901145",
    date: "2026-07-15",
    valueDate: "2026-07-15",
    description: "GRA Withholding Tax Levy",
    counterparty: "Ghana Revenue Authority",
    counterpartyAccount: "GRA-TAX-001",
    accountId: "acc-ret-002",
    currency: "GHS",
    amount: 35.0,
    direction: "debit",
  ...
  {
    id: "txn-ret-023",
    reference: "NIB-2026-901146",
    date: "2026-07-12",
    valueDate: "2026-07-12",
    description: "Wallet to Bank — Telecel Cash",
    counterparty: "Telecel Cash Agent",
    counterpartyAccount: "0200 4433 22",
    accountId: "acc-ret-002",
    currency: "GHS",
    amount: 750.0,
    direction: "credit",
  ...
  {
    id: "txn-ret-024",
    reference: "NIB-2026-901147",
    date: "2026-07-10",
    valueDate: "2026-07-10",
    description: "Restaurant Dining — Buka Accra",
    counterparty: "Buka Restaurant",
    counterpartyAccount: "0100 7766 5544",
    accountId: "acc-ret-002",
    currency: "GHS",
    amount: 280.0,
    direction: "debit",
...
export const CARDS: PaymentCard[] = [
  ...
  {
    id: "card-ret-006",
    name: "Forex Travel Prepaid",
    maskedNumber: "•••• 4180",
    fullNumber: "5412 1122 3344 4180",
    cvv: "394",
    type: "Prepaid",
    scheme: "Mastercard",
    currency: "USD",
    ...
    colorTheme: "maroon",
    deliveryMethod: "BRANCH_PICKUP",
    deliveryBranch: "GCB Airport City Branch",
    deliveryStatus: "in_production",
